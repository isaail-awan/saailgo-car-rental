...
// Login user ho to naam, phone aur email khud bhar jayen
...
export default function BookingForm({ bookingRequest, bookings = [], onConfirm }) {
  ...
  const gateState = {
    from: "/#booking",
    carId: bookingRequest ? bookingRequest.carId : undefined,
    stamp: bookingRequest ? bookingRequest.stamp : undefined,
  };
      ...
      <div className="grid gap-12 lg:grid-cols-5 items-start">
        ...
        <Reveal animation="right" delay={100} className="lg:col-span-3">
          {user ? (
            ...
            <AuthGate title="Log in to book a car" text="Create a free account or log in to send a booking request. Your details will be filled in automatically." state={gateState} />
          )}
        </Reveal>
      </div>
    </section>
